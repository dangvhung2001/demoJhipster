...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERMAIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERMAIN actions', async () => {
      const expectedActions = [
        {
