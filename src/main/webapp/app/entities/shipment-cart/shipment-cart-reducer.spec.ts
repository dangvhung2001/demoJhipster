...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIPMENTCART_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHIPMENTCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHIPMENTCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHIPMENTCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHIPMENTCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHIPMENTCART actions', async () => {
      const expectedActions = [
        {
