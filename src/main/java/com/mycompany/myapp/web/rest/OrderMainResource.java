...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.OrderMain}.
 */
@RestController
@RequestMapping("/api/order-mains")
public class OrderMainResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<OrderMainDTO> getOrderMain(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteOrderMain(@PathVariable("id") Long id) {
